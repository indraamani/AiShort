  ...
  return (
    <nav className="flex items-center justify-between fixed z-50 top-0 w-full px-6 md:px-16 lg:px-24 xl:px-32 py-4 backdrop-blur">
      ...
      <div className="hidden items-center md:gap-8 lg:gap-9 md:flex lg:pl-20 text-white">
        ...
        <a href="#pricingsection" className="hover:text-slate-600 dark:hover:text-slate-300">Pricing</a>
        <a href="#faqsection" className="hover:text-slate-600 dark:hover:text-slate-300">FAQs</a>
      </div>
      ...
      <div className="flex items-center gap-4 ">
        ...
        <button onClick={_=>navigate('/signin')} className="hidden md:block px-4 py-2 bg-purple-600 hover:bg-purple-700 transition text-white rounded-md">Get Started</button>
