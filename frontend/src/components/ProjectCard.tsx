        ...
        <div key={gen.id} className="mb-4 break-inside-avoid">
            <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
                ...
                <div className={`${gen.aspectRatio === '9:16' ? 'aspect-9/16' : 'aspect-video'} relative overflow-hidden`}>
                    {gen.generatedImg && (
                        <img src={gen.generatedImg} alt=""
                            className={`absolute inset-0 w-full object-cover transition duration-500
                    ...
                    <div className="absolute right-3 bottom-3">
                        <img src={gen.uploadedImg[0]} alt="product" className="w-16 h-16 object-cover rounded-full animate-float"/>
                        <img src={gen.uploadedImg[1]} alt="model" className="w-16 h-16 object-cover rounded-full animate-float -ml-8" style={{animationDelay: "3s"}}/>
                    </div>
                </div>
                ...
                <div className="p-4">
                    ...
                    {gen.productDesc && (
                        <div className="mt-3">
                            ...
                            <div className="text-sm text-gray-300 bg-white/3 p-2 rounded-md wrap-break-word">{gen.productDesc}</div>
                        </div>
                    )}
                    {gen.userPrompt && (
                        <div className="mt-3">
